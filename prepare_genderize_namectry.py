...
#Genderize using country & name information.
#filein="/volumes/lacie/metoo/test"+sys.argv[1]+".csv"
filein="/volumes/lacie/metoo/raw/20240802_namectrylist_piece"+sys.argv[1]+".csv"
fileout1="/volumes/lacie/metoo/raw/20240812_authorid_namectry_piece"+sys.argv[1]+".csv"
fileout2="/volumes/lacie/metoo/raw/20240812_namectry_togender_piece"+sys.argv[1]+".csv"
...
print("Outfile author-id, name-ctry "+str(sys.argv[1]))
test=test[['author_id','raw_author_name','num_works','firstname','country_code']]
test.to_csv(fileout1,index=False)

print("Outfile unique name-ctry combinations "+str(sys.argv[1]))
test_unique_ctryname=test.groupby(['firstname','country_code']).agg({'author_id':'count'})
test_unique_ctryname=test_unique_ctryname.reset_index()
test_unique_ctryname=test_unique_ctryname.drop(columns={'author_id'})
test_unique_ctryname.to_csv(fileout2,index=False)